...
void mostrar_nodo_lista_doble(nodo_lista_doble*); //extra
...
nodo_lista_doble * buscar_nodo_lista_doble(nodo_lista_doble*, int); //extra
nodo_lista_doble * borrar_primer_nodo_lista_doble(nodo_lista_doble*); //extra
nodo_lista_doble * borrar_ultimo_nodo_lista_doble(nodo_lista_doble*); //extra
nodo_lista_doble * borrar_nodo_lista_doble_por_dato(nodo_lista_doble*, int); //extra
