    ...
    while (opcion != 3)
    {
        ...
        case 1:
        {
            ...
            if (usuarioEncontrado != NULL)
            {
                for (int i = 0; i < 3; i++)
                {
                    ...
                    {
                        animacionCargando();
                        listaUsuarios = menuUsuario(usuarioEncontrado, listaUsuarios, listaPrincipal, &fila, archivoUsuarios, archivoRegistros);
                        i = 3;
                    }
                    else
                    {
        ...
        case 4:
        {
            ...
            if (usuarioEncontrado != NULL)
            {
                ...
                {
                    animacionCargando();
                    listaUsuarios = menuDeAdministradores(usuarioEncontrado, listaUsuarios, listaPrincipal, &fila, archivoUsuarios, archivoRegistros);
                }
                else
                {
