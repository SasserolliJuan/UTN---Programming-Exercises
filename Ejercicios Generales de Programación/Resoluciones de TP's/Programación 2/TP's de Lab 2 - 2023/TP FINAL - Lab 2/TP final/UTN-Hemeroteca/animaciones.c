...
{
    system("cls");
    printf("\n\n                                     Opcion no valida. Debe ingresar un numero del 1 al 11. \n\n");
    system("pause");
    system("cls");
}
...
void opcionesMenuUsuario()
{
    ...
    printf("                                     |                 ELIJA UNA DE LAS OPCIONES                 |\n");
    printf("                                     |-----------------------------------------------------------|\n");
    printf("                                     |         1. Registrar autor(es) y publicacion(es).         |\n");
    ...
    printf("                                     |         6. Busqueda de autores por nombre o nacionalidad. |\n");
    printf("                                     |         7. Comentarios y clasificaciones.                 |\n");
    printf("                                     |         8. Ver ranking de publicaciones.                  |\n");
    printf("                                     |         9. Reservar publicaciones.                        |\n");
    printf("                                     |         10. Generar recomendaciones                       |\n");
    printf("                                     |         11. Salir.                                        |\n");
    printf("                                     |___________________________________________________________|\n");
    printf("\n\n");
}
