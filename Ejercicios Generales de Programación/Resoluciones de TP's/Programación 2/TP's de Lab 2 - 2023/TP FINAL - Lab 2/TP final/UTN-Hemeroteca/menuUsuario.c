...
nodoListaUsuario *menuUsuario(nodoListaUsuario *usuarioEncontrado, nodoListaUsuario *listaUsuarios, lista_de_listas *listaPrincipal, fila *fila, char archivoUsuarios[], char archivoRegistros[])
{
    ...
    while (opcion != 11)
    {
        ...
        case 2:
        {
            ...
            do
            {
                ...
                case 1:
                {
                    ...
                    listaPrincipal = mostrarPublicacionXTitulo(listaPrincipal, tituloABuscar);
                ...
                case 2:
                {
                    ...
                    listaPrincipal = mostrarPublicacionXAutor(listaPrincipal, autorABuscar);
                ...
                case 3:
                {
                    ...
                    listaPrincipal = mostrarPublicacionXFecha(listaPrincipal, anio1, anio2);
                ...
                case 4:
                {
                    ...
                    listaPrincipal = mostrarPublicacionXPalabraClave(listaPrincipal, palabraClaveABuscar);
        ...
        case 3:
        {
            printf("" CYAN_F NEGRO_T "INFORMACION DE LAS PUBLICACIONES: " RESET_COLOR);
        ...
        case 4:
        {
            printf("" CYAN_F NEGRO_T "PUBLICACIONES ORDENADAS POR GENERO: \n\n" RESET_COLOR);
        ...
        case 7:
        {
            ...
            printf("Esta funcion se encuentra en mantenimiento. Disculpe las molestias. \n");
            system("pause");
            system("cls");
        ...
        case 9:
        {
            ...
            if ((rta == 1) && (pubEnc.prestado == 0))
            {
                ...
                listaUsuarios = agregarPublicacionAHistorial(&listaPrincipal, listaUsuarios, emailUsuarioReserva, pubEnc, fila);
                mostrarListaDeUsuarios(listaUsuarios);
                system("pause");
                system("cls");
            }
            else if (pubEnc.prestado == 1)
            {
