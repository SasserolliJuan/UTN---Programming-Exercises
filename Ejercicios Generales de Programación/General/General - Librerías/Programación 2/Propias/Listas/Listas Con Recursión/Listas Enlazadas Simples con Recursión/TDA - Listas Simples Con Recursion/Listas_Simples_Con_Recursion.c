...
void mostrarListaInvertidaR(nodo_lista_simple *lista)
{
    if(lista != NULL)
    {
...
int sumaContenidoListaR(nodo_lista_simple *lista)
{
    int rta = 0;
...
void muestraPosParR(nodo_lista_simple *lista, int pos)
{
    if(lista != NULL)
    {
        if(pos % 2 == 0)
...
void otroMuestraPosPar(nodo_lista_simple *lista)
{
    if(lista != NULL)
    {
        lista = lista->siguiente;
...
nodo_lista_simple * invertirRecursivo(nodo_lista_simple *lista)
{
    nodo_lista_simple *primero = NULL;
    ...
    if(lista != NULL)
    {
        ...
        lista = insertar_nodo_lista_simple_al_final(invertirRecursivo(lista), primero);
    }
    return lista;

}

nodo_lista_simple * borrarNodoR(nodo_lista_simple *lista, int dato)
{
    nodo_lista_simple *aBorrar = NULL;
...
nodo_lista_simple* insertarEnOrdenR(nodo_lista_simple *lista, nodo_lista_simple *nuevo_nodo)
{
    if(lista == NULL)
    {
        lista = nuevo_nodo;
    ...
    else
    {
        ...
        {
            lista->siguiente = insertarEnOrdenR(lista->siguiente, nuevo_nodo);
        }
    }
    return lista;
}
